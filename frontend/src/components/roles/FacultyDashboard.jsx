...
export default function FacultyDashboard({ currentUser }) {
  ...
  const academicEvents = [
    ...
    { id: 2, day: 2, title: 'Faculty Senate Monthly Assembly & Curriculum Review', date: 'Sep 02, 2026 • 10:00 AM', type: 'Meetings', status: 'Scheduled', venue: 'Auditorium Hall B', badgeColor: 'bg-[#3E5C76]/15 text-[#3E5C76] border-[#3E5C76]/30', dotColor: 'bg-[#3E5C76]' },
    { id: 3, day: 7, title: 'Labor Day - University Holiday', date: 'Sep 07, 2026 (All Day)', type: 'Holidays', status: 'Holiday', venue: 'Entire Campus Closed', badgeColor: 'bg-[#8A8578]/15 text-[#8A8578] border-[#8A8578]/30', dotColor: 'bg-[#8A8578]' },
    ...
    { id: 6, day: 21, title: 'Faculty Office Hours & Research Mentorship Sync', date: 'Aug 21, 2026 • Today', type: 'Meetings', status: 'Active Today', venue: 'Faculty Cabin #304', badgeColor: 'bg-[#3E5C76]/15 text-[#3E5C76] border-[#3E5C76]/30', dotColor: 'bg-[#3E5C76]' }
  ];
  ...
  return (
    <div className="space-y-6 font-sans pb-12 relative animate-in fade-in duration-300">
      ...
      {/* Toast Alert Banner */}
      {toastMsg && (
        <div className="fixed top-20 right-6 z-50 bg-[#1F2A38] text-white px-4 py-2.5 rounded-xl shadow-2xl border border-[#E2DED4] text-xs font-medium flex items-center gap-2 animate-in zoom-in-95">
      ...
      <div className="flex items-center justify-between border-b border-[#E2DED4] pb-3">
          ...
          <button
            ...
            className={`px-3.5 py-1.5 text-xs font-semibold rounded-lg transition-colors cursor-pointer flex items-center space-x-2 border ${
              activeTab === 'overview'
                ...
                : 'text-[#8A8578] hover:text-[#1F2A38] bg-[#DCD7CC] border-[#E2DED4]'
            }`}
          >
        ...
        <span className="text-xs text-[#8A8578] hidden sm:inline-block">
          Role: <strong className="text-[#3E5C76]">Faculty</strong>
        </span>
      </div>
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6 animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {/* ATTENDANCE CARD */}
            <div className="p-5 rounded-2xl border border-[#E2DED4] bg-[#DCD7CC] space-y-2 shadow-xs flex flex-col justify-between">
              <div>
                <span className="text-xs font-semibold text-[#8A8578] block">
                  Attendance Rate
                </span>
                <div className="flex items-baseline gap-2 mt-1">
                  <span className="text-3xl font-bold text-[#1F2A38] tracking-tight">{attendancePercent}%</span>
                  <span className="text-xs text-[#4E7A51] font-semibold">Optimal</span>
                </div>
              </div>
              <div className="w-full bg-[#E2DED4] h-1.5 rounded-full overflow-hidden mt-3">
            ...
            <div className="p-5 rounded-2xl border border-[#E2DED4] bg-[#DCD7CC] space-y-2 shadow-xs flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-baseline gap-2 mt-1">
                  <span className="text-3xl font-bold text-[#1F2A38] tracking-tight">{leavesTaken}</span>
                  <span className="text-xs text-[#8A8578]">days</span>
                </div>
              </div>
              <p className="text-xs text-[#8A8578] mt-3">15 Days Available in Term</p>
            </div>
            ...
            <div className="p-5 rounded-2xl border border-[#E2DED4] bg-[#DCD7CC] space-y-2 shadow-xs flex flex-col justify-between">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-baseline gap-2 mt-1">
                    <span className="text-3xl font-bold text-[#3E5C76] tracking-tight">{activeTicketsCount}</span>
                    <span className="text-xs text-[#3E5C76]/80">in dispatch</span>
                  </div>
                </div>
                <button
                  type="button"
                  onClick={() => setShowIssueModal(true)}
                  className="px-3 py-1.5 bg-[#F5F4F0] hover:bg-[#DCD7CC] text-[#3E5C76] border border-[#3E5C76]/30 rounded-full text-xs font-semibold transition-all cursor-pointer"
                >
                  + Raise Ticket
                </button>
              </div>
              <p className="text-xs text-[#8A8578] mt-2">IT Support & Maintenance Dispatch</p>
            </div>

          </div>

          {/* ================= COMPACT ACADEMIC CALENDAR ================= */}
          <div className="p-5 rounded-2xl border border-[#E2DED4] bg-[#DCD7CC] space-y-4 shadow-xs">
            
            {/* Widget Header */}
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[#E2DED4] pb-3">
              <div className="flex items-center gap-2">
                <div className="p-2 rounded-lg bg-[#3E5C76]/15 text-[#3E5C76] border border-[#3E5C76]/30">
                  <CalendarDays className="w-4 h-4" />
                </div>
                <div>
                  <h4 className="text-sm font-bold text-[#1F2A38] tracking-tight flex items-center gap-2">
                    Academic Calendar
                    <span className="text-xs font-semibold px-2 py-0.5 bg-[#F5F4F0] text-[#4E7A51] rounded-full border border-[#E2DED4]">
                      Fall Term 2026
                    </span>
                  </h4>
                </div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-2.5 py-1 bg-[#F5F4F0] hover:bg-[#DCD7CC] text-[#1F2A38] rounded-lg text-xs font-semibold border border-[#E2DED4] cursor-pointer"
                >
                  ‹ Prev
                </button>
                <span className="text-xs font-bold text-[#1F2A38] bg-[#F5F4F0] px-3 py-1 rounded-lg border border-[#E2DED4]">
                  {calendarMonth}
                </span>
                <button
                  type="button"
                ...
                <button
                  ...
                  className="px-3 py-1 bg-[#3E5C76]/15 hover:bg-[#3E5C76]/25 text-[#3E5C76] border border-[#3E5C76]/30 rounded-lg text-xs font-semibold transition-colors flex items-center gap-1 cursor-pointer"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
              ...
              <div className="lg:col-span-7 bg-[#F5F4F0] p-4 rounded-xl border border-[#E2DED4] space-y-2">
                <div className="flex items-center justify-between border-b border-[#E2DED4] pb-1.5">
                  <span className="text-xs font-semibold text-[#8A8578]">
                    Monthly Schedule Grid
                  </span>
                  <span className="text-xs text-[#3E5C76] font-semibold bg-[#DCD7CC] px-2 py-0.5 rounded-full border border-[#E2DED4]">
                    Today: Aug 21
                  </span>
                </div>
                ...
                <div className="grid grid-cols-7 gap-1 text-center">
                  {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map((d, i) => (
                    <div key={i} className="text-xs font-semibold text-[#8A8578] py-0.5">
                      {d}
                    </div>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-7 gap-1">
                  {[...Array(6)].map((_, i) => (
                    <div key={`off-${i}`} className="h-7 rounded bg-[#DCD7CC]/40 opacity-40 cursor-not-allowed" />
                  ))}
                  {[...Array(31)].map((_, idx) => {
                    const dayNum = idx + 1;
                    ...
                    return (
                      <button
                        ...
                        className={`h-7 rounded-lg border text-xs font-semibold flex flex-col items-center justify-center transition-all cursor-pointer relative ${
                          isSelected
                            ? 'bg-[#3E5C76] border-[#3E5C76] text-white shadow-xs scale-105 z-10'
                            : isToday
                            ? 'bg-[#DCD7CC] border-[#3E5C76] text-[#3E5C76] font-bold'
                            : 'bg-[#DCD7CC] border-[#E2DED4] text-[#1F2A38] hover:border-[#3E5C76]/50'
                        }`}
                      >
                        <span>{dayNum}</span>
              ...
              <div className="lg:col-span-5 bg-[#F5F4F0] p-4 rounded-xl border border-[#E2DED4] flex flex-col justify-between space-y-3">
                <div className="space-y-2">
                  <div className="flex items-center justify-between border-b border-[#E2DED4] pb-1.5">
                    <span className="text-xs font-bold text-[#1F2A38]">
                  ...
                  {academicEvents.filter(e => e.day === selectedCalendarDay || (selectedCalendarDay >= 25 && selectedCalendarDay <= 30 && e.id === 1)).length > 0 ? (
                    academicEvents.filter(e => e.day === selectedCalendarDay || (selectedCalendarDay >= 25 && selectedCalendarDay <= 30 && e.id === 1)).map(ev => (
                      <div key={ev.id} className="p-2.5 rounded-lg bg-[#DCD7CC] border border-[#E2DED4] space-y-1">
                        <div className="flex items-center justify-between">
                        ...
                        <h5 className="text-xs font-bold text-[#1F2A38] truncate">{ev.title}</h5>
                        <p className="text-xs text-[#8A8578] flex items-center gap-1 truncate">
                          <MapPin className="w-3 h-3 text-[#3E5C76]" /> {ev.venue}
                        </p>
                      </div>
                    ))
                  ) : (
                    <div className="p-3 text-center text-xs text-[#8A8578] space-y-0.5">
                      <p className="font-semibold text-[#1F2A38]">Regular Academic Schedule</p>
                      <p className="text-xs text-[#8A8578]">Standard classroom lectures and office hours on Aug {selectedCalendarDay}.</p>
                    </div>
                  )}
                </div>
                ...
                <button
                  ...
                  className="w-full py-2 bg-[#DCD7CC] hover:bg-[#E2DED4]/50 text-[#1F2A38] border border-[#E2DED4] rounded-lg text-xs font-semibold transition-colors flex items-center justify-center gap-1 cursor-pointer"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full animate-in fade-in duration-300">
            ...
            <div className={`w-full rounded-2xl border transition-all duration-300 overflow-hidden bg-[#DCD7CC] ${
              activeExpand === 'classroom'
                ? 'md:col-span-2 border-[#3E5C76] shadow-xs'
                : 'md:col-span-1 border-[#E2DED4] hover:border-[#3E5C76]/50'
            }`}>
              {/* Header Bar */}
              <div
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={`p-2.5 rounded-xl border transition-all ${
                    activeExpand === 'classroom'
                      ...
                      : 'bg-[#F5F4F0] text-[#3E5C76] border-[#E2DED4]'
                  }`}>
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-[#1F2A38] tracking-tight flex items-center gap-2">
                      ...
                      {activeExpand === 'classroom' ? (
                        <span className="text-xs font-semibold px-2 py-0.5 bg-[#3E5C76]/15 text-[#3E5C76] rounded-full border border-[#3E5C76]/30">
                          Active Workspace
                        </span>
                      ) : (
                        <span className="text-xs text-[#8A8578]">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs font-semibold text-[#3E5C76] hidden sm:inline-block">
                    {activeExpand === 'classroom' ? 'Minimize' : 'Expand'}
                  </span>
                  <div className="p-2 rounded-lg border border-[#E2DED4] bg-[#F5F4F0] text-[#8A8578]">
              ...
              {/* Expanded Body Form */}
              {activeExpand === 'classroom' && (
                <div className="px-5 pb-5 pt-2 border-t border-[#E2DED4] space-y-4 animate-in fade-in duration-300">
                  <form onSubmit={handleClassroomSubmit} className="space-y-4 text-xs font-sans">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="md:col-span-2">
                        <label className="block font-semibold text-[#1F2A38] mb-1.5">Course / Event Title</label>
                        <input
                          type="text"
                          required
                          ...
                          className="w-full px-3.5 py-2 bg-[#F5F4F0] border border-[#E2DED4] rounded-lg font-medium text-[#1F2A38] placeholder-[#8A8578]/60 focus:outline-none focus:border-[#3E5C76] transition-all"
                        />
                      </div>

                      <div>
                        <label className="block font-semibold text-[#1F2A38] mb-1.5">Priority & Category</label>
                        <select className="w-full px-3.5 py-2 bg-[#F5F4F0] border border-[#E2DED4] rounded-lg font-medium text-[#1F2A38] focus:outline-none focus:border-[#3E5C76]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      <div>
                        <label className="block font-semibold text-[#1F2A38] mb-1.5">Venue / Audi / Lab</label>
                        <select
                          value={classForm.venue}
                          onChange={(e) => setClassForm({ ...classForm, venue: e.target.value })}
                          className="w-full px-3.5 py-2 bg-[#F5F4F0] border border-[#E2DED4] rounded-lg font-medium text-[#1F2A38] focus:outline-none focus:border-[#3E5C76]"
                        >
                      ...
                      <div>
                        <label className="block font-semibold text-[#1F2A38] mb-1.5">Date</label>
                        <input
                          type="date"
                      ...
                      <div>
                        <label className="block font-semibold text-[#1F2A38] mb-1.5">Time Slot</label>
                        <select
                      ...
                      <div>
                        <label className="block font-semibold text-[#1F2A38] mb-1.5">Expected Capacity</label>
                        <input
                          type="number"
                          placeholder="e.g. 60"
                          value={classForm.capacity}
                          onChange={(e) => setClassForm({ ...classForm, capacity: e.target.value })}
                          className="w-full px-3.5 py-2 bg-[#F5F4F0] border border-[#E2DED4] rounded-lg font-medium text-[#1F2A38] placeholder-[#8A8578]/60 focus:outline-none focus:border-[#3E5C76]"
                        />
                      </div>
                    </div>

                    {/* AV Equipment Facilities */}
                    <div className="p-4 rounded-xl border border-[#E2DED4] bg-[#F5F4F0] space-y-2.5">
                      <span className="text-xs font-semibold text-[#3E5C76] block">
                        AV & Classroom Equipment
                      </span>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-[#1F2A38] font-medium">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input type="checkbox" defaultChecked className="accent-[#3E5C76] rounded" />
                        ...
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input type="checkbox" className="accent-[#3E5C76] rounded" />
                ...
                <div className="px-5 pb-5 pt-2 border-t border-[#E2DED4] space-y-4 animate-in fade-in duration-300">
                  <form onSubmit={handleVenueSubmit} className="space-y-4 text-xs font-sans">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block font-semibold text-[#1F2A38] mb-1.5">Venue Name</label>
                        <select
                      ...
                      <div>
                        <label className="block font-semibold text-[#1F2A38] mb-1.5">Event Date</label>
                        <input
                          type="date"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      <div>
                        <label className="block font-semibold text-[#1F2A38] mb-1.5">Start Time</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block font-semibold text-[#1F2A38] mb-1.5">End Time</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block font-semibold text-[#1F2A38] mb-1.5">Expected Attendees</label>
                        <input
                          type="number"
                          placeholder="e.g. 150"
                      ...
                      <div>
                        <label className="block font-semibold text-[#1F2A38] mb-1.5">VIP Parking Badges</label>
                        <input
                          type="number"
                    ...
                    <div>
                      <label className="block font-semibold text-[#1F2A38] mb-1.5">Purpose / Agenda Summary</label>
                      <textarea
                        rows={2}
                ...
                <div className="px-5 pb-5 pt-2 border-t border-[#E2DED4] space-y-4 animate-in fade-in duration-300">
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                    ...
                    <div className="lg:col-span-7 space-y-3">
                          ...
                          return (
                            <button
                              ...
                              className={`p-3 rounded-xl border text-xs transition-all cursor-pointer text-left space-y-1 ${
                                isSelected
                                  ? 'bg-[#F5F4F0] text-[#1F2A38] border-[#3E5C76] ring-1 ring-[#3E5C76] font-bold shadow-xs'
                                  : 'bg-[#F5F4F0] border-[#E2DED4] text-[#8A8578] hover:border-[#3E5C76]/50'
                              }`}
                            >
                              <div className="font-bold text-xs text-[#1F2A38]">{bus.label}</div>
                              <div className="text-xs text-[#8A8578]">{bus.busNo}</div>
                      ...
                      <div className="p-3 rounded-xl border border-[#E2DED4] bg-[#F5F4F0] space-y-1 text-xs">
                        <span className="text-xs font-semibold text-[#8A8578] block">Active Route Loop:</span>
                        <div className="flex items-center gap-1.5 text-[#8A8578] text-xs overflow-x-auto">
                          <span>Main Gate</span>
                          <span>➔</span>
                          <span>Hostel A</span>
                          <span>➔</span>
                          <span className="text-[#3E5C76] font-bold">CS Block</span>
                          <span>➔</span>
                    ...
                    <div className="lg:col-span-5 p-4 rounded-xl border border-[#E2DED4] bg-[#F5F4F0] text-[#1F2A38] space-y-3">
                      <div className="flex items-center justify-between border-b border-[#E2DED4] pb-2">
                        <h4 className="text-xs font-bold text-[#3E5C76]">
                          Bus Telemetry
                        </h4>
                      ...
                      <div className="space-y-2 text-xs text-[#8A8578]">
                        <div className="flex justify-between items-center border-b border-[#E2DED4] pb-1.5">
                          <span>Vehicle No:</span>
                          <span className="text-[#1F2A38] font-semibold">{selectedBus.busNo} ({selectedBus.label})</span>
                        </div>

                        <div className="flex justify-between items-center border-b border-[#E2DED4] pb-1.5">
                          <span>Live Location:</span>
                          <span className="truncate max-w-[160px] text-[#1F2A38] font-semibold flex items-center gap-1">
                            <MapPin className="w-3 h-3 text-[#3E5C76] inline" /> {selectedBus.loc}
                          </span>
                        </div>
                        ...
                        <div className="pt-1 text-xs text-[#8A8578] flex items-center justify-between">
                          <span>Driver: <strong className="text-[#1F2A38]">{selectedBus.driver}</strong></span>
                          <a href={`tel:${selectedBus.phone}`} className="text-[#3E5C76] font-semibold hover:underline flex items-center gap-1">
                            <Phone className="w-3 h-3" /> {selectedBus.phone}
                          </a>
                        </div>
                      </div>

                      <div className="pt-2 text-xs text-[#8A8578] flex justify-between border-t border-[#E2DED4]">
            ...
            <div className={`w-full rounded-2xl border transition-all duration-300 overflow-hidden bg-[#DCD7CC] ${
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 bg-[#F5F4F0] hover:bg-[#DCD7CC] text-[#3E5C76] border border-[#3E5C76]/30 rounded-full text-xs font-semibold transition-all cursor-pointer shrink-0 flex items-center gap-1"
                  >
                    <Plus className="w-3.5 h-3.5" />
              ...
              {activeExpand === 'tickets' && (
                <div className="px-5 pb-5 pt-2 border-t border-[#E2DED4] space-y-4 animate-in fade-in duration-300">
                  <div className="flex items-center justify-between">
                    <h4 className="text-xs font-bold text-[#1F2A38]">
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      <div key={tck.id} className="p-3.5 rounded-xl bg-[#F5F4F0] border border-[#E2DED4] space-y-2 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            <span className="text-xs font-semibold px-2 py-0.5 bg-[#DCD7CC] text-[#1F2A38] rounded border border-[#E2DED4]">
                              {tck.id}
                            </span>
                            <span className="text-xs font-semibold px-2 py-0.5 bg-[#DCD7CC] text-[#3E5C76] rounded border border-[#E2DED4]">
                              {tck.domain}
                            </span>
                            <span className={`text-xs font-semibold px-2.5 py-0.5 rounded-full border ${
                              ...
                              'bg-[#3E5C76]/15 text-[#3E5C76] border-[#3E5C76]/30'
                            }`}>
                              {tck.status}
                            </span>
                          </div>
                          <h5 className="text-xs font-bold text-[#1F2A38]">{tck.title}</h5>
                          <p className="text-xs text-[#8A8578]">Logged on {tck.date} • {tck.time}</p>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="px-3 py-1.5 bg-[#DCD7CC] hover:bg-[#E2DED4]/50 text-[#1F2A38] border border-[#E2DED4] rounded-lg text-xs font-semibold transition-colors cursor-pointer"
                          >
                            Track Status
                          </button>
                        </div>
      ...
      {activeTab === 'transport' && (
        <div className="p-6 rounded-2xl border border-[#E2DED4] bg-[#DCD7CC] space-y-6 shadow-xs">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-bold text-[#1F2A38] flex items-center gap-2">
                <Bus className="w-4 h-4 text-[#3E5C76]" />
                <span>Shuttle Bus Fleet Telemetry & GPS Radar</span>
              </h3>
              <p className="text-xs text-[#8A8578] font-medium mt-0.5">Real-time shuttle driver telemetry, seat availability, speed & route operations</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-4">
              {busFleet.map((bus) => (
                <div
                  key={bus.id}
                  onClick={() => setSelectedBus(bus)}
                  className={`p-4 sm:p-5 rounded-xl border transition-all cursor-pointer space-y-3 bg-[#F5F4F0] ${
                    selectedBus.id === bus.id
                      ? 'border-[#3E5C76] ring-1 ring-[#3E5C76] shadow-xs'
                      : 'border-[#E2DED4] hover:border-[#3E5C76]/50'
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-[#1F2A38] text-xs">{bus.busNo}</span>
                    <span className={`text-xs font-semibold px-2.5 py-0.5 rounded-full border ${
                      bus.status === 'Peak Load'
                        ? 'bg-[#A6402F]/15 text-[#A6402F] border-[#A6402F]/30'
                        : bus.status === 'Stationed'
                        ? 'bg-[#E2DED4]/40 text-[#8A8578] border-[#E2DED4]'
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-[#1F2A38]">{bus.label}</h4>
                    <p className="text-xs text-[#8A8578] mt-1 flex items-center gap-1">
                  ...
                  <div className="pt-2 border-t border-[#E2DED4] text-xs space-y-1">
                    <p className="text-[#8A8578] flex items-center justify-between">
                      <span>Driver: <strong className="text-[#1F2A38]">{bus.driver}</strong></span>
                      <span className="text-xs text-[#8A8578]">{bus.phone}</span>
                    </p>
                    <p className="text-[#8A8578] flex items-center justify-between">
                      <span>Speed: <strong className="text-[#1F2A38]">{bus.speed}</strong></span>
            ...
            <div className="lg:col-span-5 p-5 rounded-xl border border-[#E2DED4] bg-[#F5F4F0] text-[#1F2A38] space-y-4">
              
              {/* Live GPS Radar Display */}
              <div className="w-full h-24 bg-[#DCD7CC] rounded-lg border border-[#E2DED4] relative overflow-hidden flex items-center justify-between px-4">
                <div className="flex items-center gap-3 relative z-10">
                  <div className="p-2 rounded-lg bg-[#3E5C76]/15 text-[#3E5C76] border border-[#3E5C76]/30">
                    <Bus className="w-4 h-4" />
                  </div>
                  <div>
                    <span className="text-xs font-bold text-[#1F2A38] block">GPS Radar Telemetry</span>
                    <span className="text-xs text-[#8A8578]">{selectedBus.loc}</span>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between border-b border-[#E2DED4] pb-2">
                <h4 className="font-bold text-[#1F2A38] text-xs">Live Telemetry: {selectedBus.label}</h4>
                <span className="text-xs font-semibold text-[#4E7A51] px-2 py-0.5 bg-[#4E7A51]/15 rounded-full border border-[#4E7A51]/30">
                  {selectedBus.status}
                </span>
              </div>

              <div className="space-y-2 text-xs text-[#8A8578] pt-1">
                <div className="flex justify-between p-2.5 bg-[#DCD7CC] rounded-lg border border-[#E2DED4]">
                  <span>Bus Registration:</span>
                  <span className="font-bold text-[#1F2A38]">{selectedBus.busNo}</span>
                </div>

                <div className="flex justify-between p-2.5 bg-[#DCD7CC] rounded-lg border border-[#E2DED4]">
                  <span>Current Location:</span>
                  <span className="text-[#1F2A38] font-semibold truncate max-w-[150px]">{selectedBus.loc}</span>
                </div>
              ...
              <div className="pt-2 border-t border-[#E2DED4] text-xs text-[#8A8578] flex items-center justify-between">
                <span>Driver: <strong className="text-[#1F2A38]">{selectedBus.driver}</strong></span>
                <a href={`tel:${selectedBus.phone}`} className="flex items-center gap-1 text-[#3E5C76] font-semibold hover:underline">
            ...
            <form onSubmit={handleRaiseTicket} className="space-y-3.5 text-xs font-sans">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 bg-[#F5F4F0] border border-[#E2DED4] rounded-lg text-xs text-[#1F2A38] placeholder-[#8A8578]/60 focus:outline-none focus:border-[#3E5C76] transition-all"
                />
              </div>

              {/* Domain */}
              <div className="space-y-1">
                <label className="block font-semibold text-[#1F2A38]">Target Sub-Admin Domain</label>
                <select
                  value={ticketDomain}
                  onChange={(e) => setTicketDomain(e.target.value)}
                  className="w-full px-3.5 py-2 bg-[#F5F4F0] border border-[#E2DED4] rounded-lg text-xs text-[#1F2A38] focus:outline-none focus:border-[#3E5C76] transition-all"
                >
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-[#E2DED4]">
                <button
                  type="button"
                  onClick={() => setShowIssueModal(false)}
                  className="px-4 py-2 bg-[#F5F4F0] hover:bg-[#DCD7CC] text-[#1F2A38] border border-[#E2DED4] rounded-lg font-semibold cursor-pointer transition-colors"
                >
                  Cancel
                </button>
                <button

...
export default function SubAdminDashboard({ currentUser }) {
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      {/* ================= PERFECTLY ADJUSTED AUDI MANAGER HEADER BANNER BOX ================= */}
      <div className="w-full glass-panel p-5 md:p-6 rounded-3xl border dark:border-slate-800 border-slate-200 dark:bg-slate-900/95 bg-white shadow-xl relative overflow-hidden group hover-classic-lift">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4 z-10">
          <div className="space-y-1.5 max-w-3xl">
            ...
            <div className="flex items-center gap-2.5 flex-wrap">
              <span className="px-3 py-1 text-[10px] sm:text-[11px] font-black uppercase tracking-wider bg-gradient-to-r from-blue-500/20 to-indigo-500/20 text-blue-600 dark:text-blue-300 border border-blue-500/30 rounded-full flex items-center gap-1.5 shadow-sm">
                <Building2 className="w-3.5 h-3.5 text-blue-500" />
                <span>Audi Manager Interface // Class Manager</span>
              </span>
              <span className="text-[10px] sm:text-xs font-mono font-bold px-2.5 py-0.5 bg-slate-100 dark:bg-slate-950 text-slate-700 dark:text-slate-300 rounded-full border border-slate-200 dark:border-slate-800">
            ...
            <div className="flex items-center gap-2.5 flex-wrap pt-0.5">
              <h1 className="text-xl sm:text-2xl md:text-3xl font-black tracking-tight dark:text-white text-slate-900 flex items-center gap-2">
                <span>Good morning,</span>
                <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent">
                  {currentUser?.full_name || 'Marcus Brody'}
                </span>
              </h1>
              <span className="px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/30 flex items-center gap-1">
            ...
            {/* Subtitle Line */}
            <p className="text-xs md:text-sm dark:text-slate-400 text-slate-600 leading-normal font-medium">
          ...
          <div className="flex items-center gap-3 shrink-0 self-start md:self-center">
            <button
              ...
              disabled={isLoading}
              className="px-4.5 py-2.5 dark:bg-slate-950 bg-slate-100 dark:hover:bg-slate-800 hover:bg-slate-200 dark:text-white text-slate-900 rounded-2xl text-xs font-extrabold border dark:border-slate-800 border-slate-300 transition-all flex items-center space-x-2 cursor-pointer shadow-md"
            >

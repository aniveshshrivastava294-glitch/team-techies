...
export default function SubAdminDashboard({ currentUser }) {
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      {/* ================= STUNNING AUDI MANAGER HEADER BANNER BOX ================= */}
      <div className="w-full glass-panel p-6.5 rounded-3xl border dark:border-slate-800 border-slate-200 dark:bg-slate-900/95 bg-white shadow-xl relative overflow-hidden group hover-classic-lift">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-5 z-10">
          <div className="space-y-2">
            <div className="flex items-center gap-3 flex-wrap">
              <span className="px-3.5 py-1 text-[11px] font-black uppercase tracking-wider bg-gradient-to-r from-blue-500/20 to-indigo-500/20 text-blue-600 dark:text-blue-300 border border-blue-500/30 rounded-full flex items-center gap-2 shadow-sm">
                <Building2 className="w-4 h-4 text-blue-500" />
                <span>Audi Manager Interface // Class Manager</span>
              </span>
              <span className="text-xs font-mono font-bold px-3 py-1 bg-slate-100 dark:bg-slate-950 text-slate-700 dark:text-slate-300 rounded-full border border-slate-200 dark:border-slate-800">
            ...
            <p className="text-xs md:text-sm dark:text-slate-400 text-slate-600 leading-relaxed font-medium pt-0.5">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              disabled={isLoading}
              className="px-5 py-3 dark:bg-slate-950 bg-slate-100 dark:hover:bg-slate-800 hover:bg-slate-200 dark:text-white text-slate-900 rounded-2xl text-xs font-extrabold border dark:border-slate-800 border-slate-300 transition-all flex items-center space-x-2 cursor-pointer shadow-md"
            >
